    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Edit Credit details</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="transactions.php">
                ...
                <div class="form-group">
                    <label for="edit_serial_number" class="col-sm-3 control-label">Company name</label>
                 ...
                 <div class="form-group">
                    <label for="edit_serial_number" class="col-sm-3 control-label"> Expected Date</label>
                 ...
                 <div class="form-group">
                   ...
                   <div class="form-group">
                    <label for="edit_amount" class="col-sm-3 control-label">Telephone</label>
                   ...
                   <div class="form-group">
                    <label for="edit_amount" class="col-sm-3 control-label">Status</label>
