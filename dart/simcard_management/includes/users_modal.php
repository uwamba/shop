        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="users_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="address" class="col-sm-3 control-label">Role</label>

                    <div class="col-sm-9">
                      <select name="role" class="form-select" aria-label="Default select ">
                          <option selected>Select role</option>
                          <option value="3">Sales</option>
                          <option value="2">Store Man</option>
                ...
                <div class="form-group">
                    <label for="address" class="col-sm-3 control-label">Site</label>

                    <div class="col-sm-9">
                      <select  id="dropdown" name="site" style="background-color: #FFF;height:35px; important">
