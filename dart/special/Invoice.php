<?php
class Invoice{
   private $host = "mysql1003.mochahost.com";
	private $user = "reditech_live_readin";
	private $password = "Password@2020";
    private $database  = "reditech_readin_live";   
	...
	public function saveInvoice($POST) {		
		$sqlInsert = "
			...
			VALUES ('40', '".$POST['companyName']."', '".$POST['address']."', '".$POST['subTotal']."', '".$POST['taxAmount']."', '".$POST['taxRate']."', '".$POST['totalAftertax']."', '".$POST['amountPaid']."', '".$POST['amountDue']."', '".$POST['notes']."')";		
	...
	public function getInvoiceList(){
		$sqlQuery = "
			...
			WHERE user_id = '".$_SESSION['sales']."'";
		return  $this->getData($sqlQuery);
	}	
	public function getInvoice($invoiceId){
		$sqlQuery = "
			SELECT * FROM ".$this->invoiceOrderTable." 
			WHERE user_id = '".$_SESSION['sales']."' AND order_id = '$invoiceId'";
		$result = mysqli_query($this->dbConnect, $sqlQuery);	
